...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  { sourceId: "postman", name: "Postman Careers", url: "https://www.postman.com/company/careers/open-positions/", status: "unresolved", role: "validation_oracle", note: "Collector c_mt0kenri1czi6msxio handed its run to batch j_mt0kix8hl18ggr55o; polling stopped before any output was returned." },
