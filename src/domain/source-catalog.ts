...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  { sourceId: "cred", name: "CRED Careers", url: "https://careers.cred.club/openings", status: "unresolved", role: "candidate", scope: { geography: null, department: null, careerStage: null, employmentType: null, boardKind: "all_jobs" }, note: "Direct Lever collector c_mt0jsv3s22rjyq5w83 reached code generation but did not complete during bounded polling." },
