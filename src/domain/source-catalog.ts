...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  { sourceId: "browserstack", name: "BrowserStack Workday", url: "https://browserstack.wd3.myworkdayjobs.com/External", status: "unresolved", role: "candidate", scope: { geography: null, department: null, careerStage: null, employmentType: null, boardKind: "all_jobs" }, note: "Board collector c_mt0iq7oysxok3r6q4 and scoped detail collector c_mt0k5nx71ktmkmh3ul did not complete during bounded polling." },
  ...
  { sourceId: "cred", name: "CRED Careers", url: "https://careers.cred.club/openings", status: "unresolved", role: "candidate", scope: { geography: null, department: null, careerStage: null, employmentType: null, boardKind: "all_jobs" }, note: "Direct Lever collector c_mt0jsv3s22rjyq5w83 returned zero rows on one bounded public detail probe and remains unresolved; no retry planned." },
